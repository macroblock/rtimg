...
var re1 = regexp.MustCompile(`^\w+_\d{4}__(?:sd|hd|3d)(?:_\w+)*_(190-230|350-500|525-300|780-100|810-498|270-390|1620-996|503-726|1140-726|3510-1089|100-100|140-140)\.poster(?:#[0-9a-fA-F]{8})?\.(?:jpg|png)$`)
var re2 = regexp.MustCompile(`^(?:sd|hd)_\d{4}(?:_3d)?(?:_\w+)+__(?:\w+_)*poster(190x230|350x500|525x300|780x100|810x498|270x390|1620x996|503x726|1140x726|3510x1089|100x100|140x140)(?:#[0-9a-fA-F]{8})?\.(?:jpg|png)$`)
